...
parser.add_argument(
    ...
    type=int,
    default=97,
    help="Split a dataset into trainining and validation by percentage (default: 97)",
)
...
parser.add_argument(
    "--batch_size", "-b", type=int, default=1, help="batch size (default:1)"
)
parser.add_argument(
    "--workers",
    "-w",
...
parser.add_argument(
    "--weight_decay", type=float, default=0, help="the weight decay for whole network "
)
parser.add_argument(
    "--patience", type=int, default=5, help="the patience of reduce on plateou"
)
parser.add_argument(
    "--factor", type=float, default=0.2, help="the factor of reduce on plateou"
)
#
parser.add_argument(
    "--pretrained",
